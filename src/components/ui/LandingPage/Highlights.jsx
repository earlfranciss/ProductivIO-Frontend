                ...
                <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
                    ...
                    <div className="relative lg:row-span-2">
                        ...
                        <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
                            <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                                <p className="mt-2 text-lg font-medium tracking-tight text-white max-lg:text-center">Cross-device Access</p>
                                <p className="mt-2 max-w-lg text-sm/6 text-gray-400 max-lg:text-center">
                                    Manage your tasks and notes seamlessly on desktop, mobile, and tablet.
                                </p>
                            </div>
                    ...
                    <div className="relative max-lg:row-start-1">
                        ...
                        <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                            <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                                <p className="mt-2 text-lg font-medium tracking-tight text-white max-lg:text-center">Fast & Responsive</p>
                                <p className="mt-2 max-w-lg text-sm/6 text-gray-400 max-lg:text-center">
                                    Quickly organize tasks, projects, and deadlines without lag or delay.
                                </p>
                            </div>
                    ...
                    <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
                        ...
                        <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)]">
                            <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                                <p className="mt-2 text-lg font-medium tracking-tight text-white max-lg:text-center">Secure Data</p>
                                <p className="mt-2 max-w-lg text-sm/6 text-gray-400 max-lg:text-center">
                                    Keep all your tasks, notes, and project data safe with end-to-end encryption.
                                </p>
                            </div>
                    ...
                    <div className="relative lg:row-span-2">
                        ...
                        <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                            <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                                <p className="mt-2 text-lg font-medium tracking-tight text-white max-lg:text-center">Integrations & APIs</p>
                                <p className="mt-2 max-w-lg text-sm/6 text-gray-400 max-lg:text-center">
                                    Connect with other apps and automate your workflows with our powerful APIs.
                                </p>
                            </div>
                                ...
                                <div className="absolute top-10 right-0 bottom-0 left-10 overflow-hidden rounded-tl-xl bg-gray-900/60 outline outline-white/10">
                                    <div className="flex bg-gray-900 outline outline-white/5">
                                        <div className="-mb-px flex text-sm/6 font-medium text-gray-400">
                                            <div className="border-r border-b border-r-white/10 border-b-white/20 bg-white/5 px-4 py-2 text-white">Tasks.jsx</div>
                                            <div className="border-r border-gray-600/10 px-4 py-2">Dashboard.jsx</div>
                                        </div>
                                    </div>
                                    <div className="px-6 pt-6 pb-14">
                                        {/* Example code or screenshots can go here */}
                                    </div>
                                </div>
                            </div>
                        </div>
