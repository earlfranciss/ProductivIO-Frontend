            ...
            <div>
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-zinc-400">Card {currentCardIndex + 1} of {currentSet.cards.length}</p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-2xl font-bold text-emerald-500">
                    {Math.round(((currentCardIndex + 1) / currentSet.cards.length) * 100)}%
                  </div>
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div
                  ...
                  className={`rounded-xl p-12 border min-h-[400px] flex items-center justify-center cursor-pointer transition-all mb-6
                    ${isFlipped
                      ? "bg-zinc-800/50 border-zinc-700 hover:border-zinc-500/50"
                      : "bg-zinc-800 border-zinc-700 hover:border-zinc-500/50"
                    }`}
                >
                ...
                {currentCardIndex === currentSet.cards.length - 1 && (
                  <div className="mt-6 bg-emerald-500/20 border border-emerald-500/50 rounded-xl p-6 text-center">
                    ...
                    <p className="text-zinc-400 mb-4">You have reviewed all {currentSet.cards.length} cards</p>
                    <button
                      onClick={() => {
                        setCurrentCardIndex(0);
                        setIsFlipped(false);
                      }}
                      className="mx-1 bg-emerald-600 hover:bg-emerald-700 px-6 py-2 rounded-lg font-medium transition-colors"
                    >
                      Review Again
                    </button>
                    <button
                      onClick={() => setView('library')}
                      className="mx-1 bg-zinc-700 hover:bg-zinc-600 px-6 py-2 rounded-lg font-medium transition-colors"
                    >
                      Finish Review
                    </button>
                  </div>
                    ...
                    <div className="space-y-4">
                      {newSet.cards.map((card, index) => (
                        <div key={index} className="bg-zinc-900 rounded-lg p-4 border border-zinc-700">
                          <div className="flex items-center justify-between mb-3">
                            <span className="text-sm font-medium text-zinc-400">Card {index + 1}</span>
